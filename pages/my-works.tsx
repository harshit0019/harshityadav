...
const MyWorks: React.FC<indexProps> = () => {
    ...
    <>
      <div id="menu-target" data-scroll-container ref={refScroll}>
        ...
        <main className="container">
          <section id="sectionProjects" className="section-projects" style={{ marginTop: "10rem" }}>
            <h1 className="heading-1">
              <span>All Projects</span> <small>📊</small>
            </h1>
            <p className="paragraph">
              A comprehensive list of my data analysis and engineering work.
            </p>
